...
"""
Pruning of AlexNet on ImageNet dataset.
The code uses tensorpack dataflow
http://tensorpack.readthedocs.io/en/latest/tutorial/input-source.html

A reference implementation is also considered when wriing the code:
DoReFa-Net
https://github.com/ppwwyyxx/tensorpack/tree/0e4ddfd63bd75050fd82b28028b4d82e67b70cab/examples/DoReFa-Net
"""
